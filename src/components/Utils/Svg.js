  ...
  return (
    <div>
      <svg className="hidden">
        ...
        <symbol id='question-mark-circle-fill' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
        ...
        <symbol id='x-circle-fill' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
