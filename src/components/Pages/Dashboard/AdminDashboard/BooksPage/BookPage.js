    ...
    <main className="max-w-[1332px] w-full px-4 md:px-8 pb-5 md:pb-8 mx-auto">
      <StatusOverview button={{text:'ثبت کتاب جدید',link:'/admin-dashboard/add-book'}} 
        items={[
                ...
                {id:2,icon:'#all-ticket',text:'کتاب های تخفیف دار',value:0},
                {id:3,icon:'#bookmark',text:'کتاب های ناموجود',value:0},
              ]}/>
        ...
        <div class="relative dir-ltr overflow-x-scroll lg:overflow-auto">
            <table class="table">
                ...
                <thead class="table__head">
                    <tr>
                        <th class="table__head--row"></th>
                        <th class="table__head--row">موجودی</th>
                        <th class="table__head--row">وضعیت کتاب</th>
                        <th class="table__head--row">تعداد خریداران</th>
                        ...
                        <th class="table__head--row">ردیف</th>
                    </tr>
                </thead>
                {/* body */}
                <tbody class="table__body">
                    {
                        ...
                        <tr class="table__body--row">
                            <td className=''>
                                <button className='rounded-md px-2 py-1 bg-red-500'>حذف</button>
                                <button className='rounded-md px-2 py-1 bg-yellow-500 ml-2'>ویرایش</button>
                            </td>
